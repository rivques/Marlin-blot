...
#define BOARD_INFO_NAME "Hack Club Blot"
#define DEFAULT_MACHINE_NAME "Hack Club Blot"
...
#define SERVO0_PIN                            0 // these pins are the XIAO's "micropython" pin numbers

//
// Limit Switches
//
#define X_STOP_PIN                            23 // these pins aren't broken out on the XIAO
#define Y_STOP_PIN                            24 // but they're defined so that Marlin is happy
